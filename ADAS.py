...
def process_img(image):
    ...
    vertices = np.array([[50,800],[50,400],[1000,400],[1000,800]], np.int32)
  ...
  with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
      ...
      while True:
        ...
        screen =  np.array(ImageGrab.grab(bbox=(50,250,900,900)))
        new_screen,original_image, m1, m2 = process_img(screen)
        cv2.imshow('window', cv2.resize(new_screen,(300,300)))
